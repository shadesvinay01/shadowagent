         ...
         <AnimatePresence mode="wait">
            ...
            >
               ...
               <div className="w-full max-w-md">
                  {currentStep === 3 && (
                    <div className="p-8 rounded-[2.5rem] glass-panel flex flex-col items-center gap-6">
                       ...
                       <p className="text-[10px] font-bold text-white/20 uppercase tracking-[0.3em]">Neural Link Protocol Ready</p>
                    </div>
                  )}
                  ...
                  {currentStep === 5 && (
                    <div className="space-y-6">
                       <input 
                          ...
                          className="w-full bg-white/[0.03] border-2 border-white/10 rounded-2xl px-8 py-5 text-xl font-bold tracking-widest text-center text-white focus:border-cyan-500/40 focus:outline-none"
                       />
                    </div>
                  )}
               </div>
               ...
               <div className="flex items-center gap-6">
                  {currentStep > 1 && (
                    <button onClick={() => setCurrentStep(currentStep - 1)} className="px-10 py-5 rounded-2xl border border-white/5 text-white/30 font-bold uppercase tracking-widest">
                       Previous
                    </button>
                  )}
                  <button onClick={next} className="btn-primary flex items-center gap-4 px-12 py-5 text-lg">
