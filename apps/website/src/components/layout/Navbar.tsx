    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={onDownload}
            className="hidden md:flex items-center gap-2 px-5 py-2.5 bg-white text-black text-sm font-syne font-bold rounded-full hover:bg-white/90 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_20px_rgba(255,255,255,0.1)]"
          >
          ...
          >
            <div className="p-6 flex flex-col gap-5">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-5 py-3 bg-white text-black text-sm font-syne font-bold rounded-full shadow-[0_0_20px_rgba(255,255,255,0.1)]"
              >
