  ...
  return (
    <section className="relative min-h-[90vh] w-full flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
      <div className="container mx-auto px-6 relative z-20 text-center flex flex-col items-center">
        ...
        >
          {/* Windows - GitHub Release (trusted by Chrome/Google) */}
          <a
            href="https://github.com/shadesvinay01/shadowagent/releases/download/v1.0.0/shadowagent.exe"
          ...
          <a
            href="https://github.com/shadesvinay01/shadowagent/releases/download/v1.0.0/shadowagent.zip"
